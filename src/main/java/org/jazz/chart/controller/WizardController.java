...
public class WizardController {
    ...
    public String processFirstStep(final @ModelAttribute("song") Song song, final Errors errors) {
        // do something with song, errors, request, response,
    ...
    //                          final @ModelAttribute("song") Song song,
    ...
    public String processFinish(final @ModelAttribute("song") Song song, final Errors errors,
    ...
    public String processCancel(final HttpServletRequest request, final HttpServletResponse response, final SessionStatus status) {
        status.setComplete();
        return "canceledView";
    }
